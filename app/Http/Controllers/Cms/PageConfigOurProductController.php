...
class PageConfigOurProductController extends Controller
{
    protected $getFileDir = 'config_json/our-product.json';
    ...
    public function index()
    {
        ...
        return view('cms.page.page-config-our-product', compact( 'arrConf' ));
    }
    ...
    private function storeImg($arrConf,$input)
    {
        ...
        $path_file = $dir_file.'product_'.$input['for'].'_'.$input['key'].'_'.$input['img_name'];
        try {
