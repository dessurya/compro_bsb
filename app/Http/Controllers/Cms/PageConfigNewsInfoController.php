...
class PageConfigNewsInfoController extends Controller
{
    protected $getFileDir = 'config_json/news-info.json';
    ...
    public function index()
    {
        ...
        return view('cms.page.page-config-news-info', compact( 'arrConf' ));
    }
    ...
    private function storeImg($arrConf,$input)
    {
        ...
        $path_file = $dir_file.'news_'.$input['for'].'_'.$input['key'].'_'.$input['img_name'];
        try {
