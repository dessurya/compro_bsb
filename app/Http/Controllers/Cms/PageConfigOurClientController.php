...
class PageConfigOurClientController extends Controller
{
    protected $getFileDir = 'config_json/our-client.json';
    ...
    public function index()
    {
        ...
        return view('cms.page.page-config-our-client', compact( 'arrConf' ));
    }
    ...
    private function storeImg($arrConf,$input)
    {
        ...
        $path_file = $dir_file.'client_'.$input['for'].'_'.$input['key'].'_'.$input['img_name'];
        try {
