<nav id="header" class="fixed-top p-4">
    ...
    <div class="asd">
        <button class="btn-menu-toggle d-md-none d-lg-block d-lg-none d-xl-block" onclick="this.classList.toggle('opened');this.setAttribute('aria-expanded', this.classList.contains('opened'))" aria-label="Main Menu">
