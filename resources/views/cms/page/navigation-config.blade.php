...
<script>
    ...
    submitFormConfigPage = async () => {
        let param = {}
        param.id = $('#ConfigPageShow [name=id]').val()
        param.identity = $('#ConfigPageShow [name=identity]').val()
        param.meta_author = $('#ConfigPageShow [name=meta_author]').val()
        param.name = {}
        param.name.id = $('#ConfigPageShow [name=name_id]').val()
        param.name.en = $('#ConfigPageShow [name=name_en]').val()
        param.meta_description = {}
        param.meta_description.id = $('#ConfigPageShow [name=meta_description_id]').val()
        param.meta_description.en = $('#ConfigPageShow [name=meta_description_en]').val()
        param.meta_keywords = {}
        param.meta_keywords.id = $('#ConfigPageShow [name=meta_keywords_id]').val()
        param.meta_keywords.en = $('#ConfigPageShow [name=meta_keywords_en]').val()
        param.meta_title = {}
        param.meta_title.id = $('#ConfigPageShow [name=meta_title_id]').val()
        param.meta_title.en = $('#ConfigPageShow [name=meta_title_en]').val()
